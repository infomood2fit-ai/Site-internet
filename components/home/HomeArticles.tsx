      ...
      {item.image ? (
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(to bottom, rgba(0,0,0,0.35) 0%, rgba(0,0,0,0.70) 55%, rgba(0,0,0,0.92) 100%)",
            }}
          />
        </div>
      ) : (
  ...
  return (
    <section style={{ background: "#f7f4fb" }} className="py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-16">
        ...
        <div className="grid md:grid-cols-3 gap-5 items-stretch" style={{ gridAutoRows: "1fr" }}>
